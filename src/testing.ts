...
const timezoneAbbreviations = [
    ...
    'ANAT', // Anadyr Time
    'APER','ARST','AST','AWDT','AWST','AZOST','AZOT','AZT',
    'BDT','BIOT','BIT','BOT',
    'BRST','BRT','BST','BTT','CCT','CDT','CET','CHADT','CHAST','CLT','CLST','COST','COT','CST','CT','CVT','CXT',
    'DAVT','DDUT',
    'DFT',
    'EASST','EAST','EAT','EDT','EEST','EET','EGST','EGT',
    'EIT',
    'EST','FET','FJT','FKST','FKT','FNT',
    'GALT','GAMT','GET','GFT','GILT','GIT','GMT','GST','GYT',
    'HDT','HKT','HMT','HOVST','HOVT',
    'ICT','IDT','IOT','IRKT','IRST','IST','JST',
    'KGT','KOST','KRAT','KST','LHST','LINT',
    'MAGT','MART','MAWT','MDT','MET','MEST',
    'MHT','MIST','MIT','MMT','MSK','MST','MUT','MVT',
    'MYT','NCT','NDT','NFT','NOVT','NPT','NST','NT',
    'NUT','NZDT','NZST','OMST',
    'ORAT','PDT','PET','PETT',
    'PGT','PHOT','PHT','PKT','PMDT','PMST',
    'PONT',
    'PST','PWT','PYST','PYT',
    'RET','ROTT','SAKT','SAMT','SAST',
    'SBT','SCT','SDT','SGT','SLST','SRET','SRT',
    'SST','SYOT','TAHT','THA',
    'TFT','TJT','TKT','TLT','TMT','TRT','TOT','TVT',
    'ULAT','USZ1','UTC','UYST','UYT','UZT',
    'VET','VLAT','VOLT','VOST','VUT',
    'WAKT','WAST','WAT','WEST','WET','WIT','WST','YAKT',
    'YEKT'
];
timezoneAbbreviations.forEach(abbreviation => {
    ...
    if (matches.length > 0) {
        abbreviationMapping[abbreviation] = matches[0];
    }
});

console.log(abbreviationMapping);