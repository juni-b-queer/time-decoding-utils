...
let examplesConvertDateTimeToISO = [
    {
        input: "12/24/2024",
...
let examplesExtractDateTime = [
    ...
    {
        input: "4PM on 9/3/24 a long string of words and stuff that also has the word on or at to throw off and test the functions handling",
        expected: "9/3/24 4PM"
    },
    {
